...
export default function Footer() {
  const linkStyle =
    "text-gray-400 hover:text-white transition-colors duration-300 py-2 block";

  return (
    <footer className='py-12 px-4 bg-gray-800 text-gray-300 border-t border-gray-700'>
      <div className='container mx-auto max-w-6xl'>
        <div className='grid grid-cols-1 sm:grid-cols-3 gap-8'>
          <div>
            ...
            <p className='text-sm text-gray-400'>
              ...
              want to do, while leadership is about inspiring people to do
              things they never thought they could. — Steve Jobs
            </p>
          </div>
          <div>
            ...
            <div className='flex flex-col'>
              <Link to='/track-two' className={linkStyle}>
                <svg
                  xmlns='http://www.w3.org/2000/svg'
              ...
              <Link to='/track-two/about' className={linkStyle}>
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  className='h-5 w-5 inline mr-2'
                  fill='none'
          ...
          <div>
            ...
            <p className='text-sm text-gray-400 mb-4'>
              Follow us on social media for daily products inspiration and tips.
            </p>
        ...
        <div className='flex flex-col sm:flex-row justify-between items-center'>
          <p className='text-sm text-gray-400 mb-4 sm:mb-0'>
            © {new Date().getFullYear()} List of Employees. All rights reserved.
          </p>
          <div>
            <Link
              to='#privacy-policy'
